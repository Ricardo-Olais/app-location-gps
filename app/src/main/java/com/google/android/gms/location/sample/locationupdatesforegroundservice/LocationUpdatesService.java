        ...
        Thread thread = new Thread(new Runnable() {
            ...
            public void run() {
                ...
                HttpURLConnection urlConnection = null;
                 ...
                 mLocation.getSpeed();
                 String valores=mLocation.getLatitude()+","+mLocation.getLongitude()+","+mLocation.getSpeed();
                ...
                try  {
                    try {
                        ...
                        url = new URL("http://www.fasttransfer.com.mx:8080/inserta?imei="+imei+"&valores="+valores+"&pila="+bateria);
